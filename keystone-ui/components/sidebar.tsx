...
export const AdminSidebar = ({ ignoreSize }: { ignoreSize?: boolean }) => {
    ...
    return (
        <div className="sidebar">
            ...
            {!searchParams.has("hidehome") && <SidebarItem title="Home" onClick={() => { router.push("/admin" + (searchParams.has("hideheader") ? "?hideheader" : "") + (searchParams.has("hidehome") ? "&hidehome" : "")) }} Icon={HomeIcon} active={path === "/admin"} index={0} />}
            <SidebarItem title="Information" onClick={() => { router.push("/admin/information" + (searchParams.has("hideheader") ? "?hideheader" : "") + (searchParams.has("hidehome") ? "&hidehome" : "")) }} Icon={PenIcon} active={path === "/admin/information"} index={1} />
