...
import { SetLogo, SetDescription, SetDisplayName, SetGroupCreationPermission } from "@/components/infromationEdit";
    ...
    return (
        <motion.div className="admin-page" initial={{ x: "50px" }} animate={{ x: "0px" }} transition={{ duration: 0.2, ease: "easeInOut" }}>
            ...
            {tenant.data?.tenant && <div className="admin-page-content" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                ...
                <SetGroupCreationPermission defaultGroupCreationPermission={tenant.data?.tenant?.allowGroupCreation || false} />
            </div>}
        </motion.div>
    )
}